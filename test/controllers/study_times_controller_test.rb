...
class StudyTimesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create study_time" do
    assert_difference('StudyTime.count') do
      post study_times_url, params: { study_time: { date: @study_time.date, time: @study_time.time, user_id: @study_time.user_id } }
    end
  ...
  test "should update study_time" do
    patch study_time_url(@study_time), params: { study_time: { date: @study_time.date, time: @study_time.time, user_id: @study_time.user_id } }
