class StudyTimesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @study_time.update(study_time_params)
        format.html { redirect_to study_time_url(@study_time), notice: "Study time was successfully updated." }
  ...
  private
    ...
    def study_time_params
      params.require(:study_time).permit(:user_id, :date, :time)
    end
end
